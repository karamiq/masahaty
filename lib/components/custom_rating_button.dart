...
class CustomRatingButton extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CustomRatingButton> createState() => _RatingButtonState();
}

class _RatingButtonState extends ConsumerState<CustomRatingButton> {
        ...
        onPressed: () {
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              contentPadding: const EdgeInsets.all(CustomPageTheme.bigPadding),
                  ...
                  ? SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(
                            height: CustomPageTheme.veryBigpadding * 1.5,
                          ),
                          RatingBar.builder(
