...
class InfoTable extends StatelessWidget {
  ...
  final List<StorageFeature> features;
        ...
        DetailsTableRow(
          borderRadius: currentLanguage == const Locale('ar')
              ? const BorderRadius.only(
                  topRight: Radius.circular(CoustomBorderTheme.normalBorderRaduis),
                )
              : const BorderRadius.only(
                  topLeft: Radius.circular(CoustomBorderTheme.normalBorderRaduis),
                ),
